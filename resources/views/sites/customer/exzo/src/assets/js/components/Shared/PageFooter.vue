            ...
            <div class="footer-top">
                <div class="row">
                    <div class="col-sm-6 col-md-3 col-xs-b30 col-md-b0">
                        <img src="img/customer/exzo/logo-1.png" alt="" />
                    ...
                    <div class="col-sm-6 col-md-3 col-xs-b30 col-sm-b0">
                        ...
                        <div class="footer-post-preview clearfix">
                            <a class="image" href="#"><img src="img/customer/exzo/thumbnail-1.jpg" alt="" /></a>
                        ...
                        <div class="footer-post-preview clearfix">
                            <a class="image" href="#"><img src="img/customer/exzo/thumbnail-2.jpg" alt="" /></a>
                            <div class="description">
                                <div class="date">apr 07 / 15</div>
                                <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                            </div>
                        ...
                        <div class="footer-post-preview clearfix">
                            <a class="image" href="#"><img src="img/customer/exzo/thumbnail-3.jpg" alt="" /></a>
                            <div class="description">
                                <div class="date">apr 07 / 15</div>
                                <a class="title">Fusce tincidunt accumsan pretium sit amet</a>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xs-text-center col-lg-text-right">
                        <div class="footer-payment-icons">
                            <a class="entry"><img src="img/customer/exzo/thumbnail-4.jpg" alt="" /></a>
                            <a class="entry"><img src="img/customer/exzo/thumbnail-5.jpg" alt="" /></a>
                            <a class="entry"><img src="img/customer/exzo/thumbnail-6.jpg" alt="" /></a>
                            <a class="entry"><img src="img/customer/exzo/thumbnail-7.jpg" alt="" /></a>
