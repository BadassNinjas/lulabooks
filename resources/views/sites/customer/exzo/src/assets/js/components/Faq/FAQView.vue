...
<div>
    <div class="row">
        <div class="col-sm-5">
            <div class="simple-article size-3 grey uppercase col-xs-b5">Frequently Asked Questions</div>
            <div class="h2">LulaBooks FAQ</div>
        ...
        <div class="col-sm-7">
            <div class="simple-article size-5">
                <ul>
                    ...
                    <li> Click on sell textbook</li>
                    <li> Fill in the form</li>
                    <li> Will have sales person to contact you for quality and quotation agreement</li>
                    <li> Then your text book is up on our website</li>
                    <li> Collect and pay cash or EFT upon sale</li>
                </ul>
                <ul>
                    <b>How to buying new/second hand books</b>
                    <li> Click on books</li>
                    <li> Pops up categories and navigate to your specification</li>
                    <li> Book list will show up with option drop down menu</li>
                    <li> Click to your preferred option then add to cart, can add as long as you want</li>
                    <li> Go up to cart, then proceed to checkout when done</li>
                    <li> Fill in details and make your purchase</li>
                </ul>
            </div>
        </div>
    </div><br><br>
